      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="prose prose-zinc max-w-none space-y-6 text-zinc-600">
          ...
          <ul className="list-disc pl-5 space-y-2">
            <li><strong>Personal Data:</strong> Personally identifiable information, such as your name, email address, and telephone number, that you voluntarily give to us when you register with the website or when you choose to participate in various activities related to the website.</li>
            <li><strong>CV Data:</strong> Information contained in the resumes/CVs you upload, including work history, education, and skills.</li>
            <li><strong>Usage Data:</strong> Information about how you use our website, such as your IP address, browser type, and operating system.</li>
          </ul>
          ...
          <h2 className="text-xl font-bold text-zinc-900">3. Disclosure of Your Information</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-zinc-900">4. Security of Your Information</h2>
          <p>
