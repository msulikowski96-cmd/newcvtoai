    ...
    <div className="min-h-screen bg-white text-zinc-900 font-sans p-6 md:p-12">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="prose prose-zinc max-w-none space-y-6 text-zinc-600">
          ...
          <h2 className="text-xl font-bold text-zinc-900">2. Accounts</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-zinc-900">4. Links To Other Web Sites</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-zinc-900">5. Termination</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-zinc-900">6. Governing Law</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-zinc-900">7. Changes</h2>
          <p>
